...
export default function QuiSom({ lang, setRoute }) {
  const L = d(lang).quisom;
  return (
    <main className="long-page" id="main">
      <div className="long-shell">
        ...
        <div className="long-foot">
          ...
          <button className="btn btn-primary btn-sm" style={{ marginTop: "var(--s-4)" }} onClick={() => setRoute("sim")}>
            <span>{L.cta}</span><span className="btn-arrow" aria-hidden="true">→</span>
          </button>
        </div>
      </div>
    </main>
