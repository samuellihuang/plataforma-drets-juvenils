...
const ca = {
  ...
  topics: {
    eyebrow: "6 escenaris · Simulador interactiu",
    ...
    items: [
      ...
      { num: "03", title: "Identificació policial", body: "Drets davant la policia, multes de la Llei Mordassa, escorcolls i gravació d'agents.", scenario: "policial" },
      { num: "04", title: "Conflicte familiar", body: "Emancipació als 16, situacions de risc i opcions selon l'edat.", scenario: "familiar" },
      { num: "05", title: "Drets digitals", body: "Fotos sense permís, sextorsió, assetjament en línia i dret a l'oblit.", scenario: "digital" },
      { num: "06", title: "Salut mental", body: "Psicòleg sense permís parental, ingressos involuntaris i autonomia mèdica.", scenario: "salut" },
    ],
  },
  testimonials: {
    eyebrow: "Veus reals",
